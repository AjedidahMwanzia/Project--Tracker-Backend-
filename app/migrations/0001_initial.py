# Generated by Django 4.0.6 on 2022-07-11 19:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stack', models.CharField(choices=[('a', 'Android'), ('b', 'Fullstack')], max_length=1)),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('member', models.ManyToManyField(to='app.member')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='user',
            name='cohort',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='app.cohort'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
